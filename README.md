...
* For those with maths/stats background that want to go slightly deeper into the topic:
  * Hastie et al (2009). [The Elements of Statistical Learning. Springer.](https://canvas.instructure.com/files/212150967/download?download_frd=1) <!--https://web.stanford.edu/~hastie/ElemStatLearn/. -->
  Chapters 2 and 3
